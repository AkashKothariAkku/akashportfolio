                            ...
                            <ul className="ul-reset">
                                <li className="d-flex flex-wrap align-items-center position-relative wow fadeInRight"
                                    ...
                                    <div className="text-box">
                                        <p>Phone</p>
                                        <Link href="tel:917014691978">+91 7014691978</Link>
                                    </div>
                                </li>
                                <li className="d-flex flex-wrap align-items-center position-relative wow fadeInRight"
                                    data-wow-delay=".5s">
                                    ...
                                    <div className="text-box">
                                        <p>Email</p>
                                        <Link href="mailto:akashkothari80@mail.com">akashkothari80@mail.com</Link>
                                    </div>
                                </li>
                                <li className="d-flex flex-wrap align-items-center position-relative wow fadeInRight"
                                    data-wow-delay=".6s">
                                    ...
                                    <div className="text-box">
                                        <p>Address</p>
                                        <Link href="#">Jaipur, <br />Rajasthan, India</Link>
                                    </div>
                                </li>
                            </ul>
                        </div>
