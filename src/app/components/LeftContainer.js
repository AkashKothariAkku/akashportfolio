...
export const LeftContainer = () => {
  return (
    ...
    <div className="hero-content-box">
        <span className="hero-sub-title wow fadeInLeft" data-wow-delay="1.1s">I am Akash</span>
        <h1 className="hero-title wow fadeInLeft" data-wow-delay="1.2s">MERN Stack Developer +<br />Next Developer
        </h1>
